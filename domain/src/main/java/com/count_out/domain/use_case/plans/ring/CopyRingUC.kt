...
class CopyRingUC @Inject constructor(configuration: Configuration, private val core: RingCore
): UseCase<CopyRingUC.Request, CopyRingUC.Response>(configuration)  {

    override fun method(request: Request): Flow<ResultDomain<Domain>> = core.copy(request.ring)
