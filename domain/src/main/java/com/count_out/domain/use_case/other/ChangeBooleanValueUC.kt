...
class ChangeBooleanValueUC @Inject constructor(configuration: Configuration
): UseCase<ChangeBooleanValueUC.Request, ChangeBooleanValueUC.Response>(configuration)  {
