...
class CollapsingWorkDownUC @Inject constructor(configuration: Configuration
): UseCase<CollapsingWorkDownUC.Request, CollapsingWorkDownUC.Response>(configuration)  {
