...
class ChangeGoalUC @Inject constructor(
    configuration: Configuration, private val core: SetCore
): UseCase<ChangeGoalUC.Request, ChangeGoalUC.Response>(configuration)  {

    override fun method(request: Request): Flow<ResultDomain<Domain>> = core.changeGoal(request.item)
