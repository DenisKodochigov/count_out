...
class DelRingUC @Inject constructor(configuration: Configuration, private val core: RingCore
): UseCase<DelRingUC.Request, DelRingUC.Response>(configuration)  {

    override fun method(request: Request): Flow<ResultDomain<Domain>> = core.del(request.ring)
