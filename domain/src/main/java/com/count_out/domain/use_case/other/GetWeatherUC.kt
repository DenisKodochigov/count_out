...
class GetWeatherUC @Inject constructor(
    configuration: Configuration, private val repo: WeatherRepo,
    ...
    data class Request(val latitude: Double, val longitude: Double, val timezone: String) :
        UseCase.Request
