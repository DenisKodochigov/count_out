...
class ShowBSSpeechWorkDownUC @Inject constructor(configuration: Configuration
): UseCase<ShowBSSpeechWorkDownUC.Request, ShowBSSpeechWorkDownUC.Response>(configuration)  {
