...
class CountOutServiceBindUC @Inject constructor(configuration: Configuration, private val core: CountOutServiceCore
): UseCase<CountOutServiceBindUC.Request, CountOutServiceBindUC.Response>(configuration)  {

    override fun method(request: Request): Flow<ResultDomain<Domain>> = core.bind()
