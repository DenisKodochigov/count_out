...
data class DataForUI (
    ...
    val durationSpeech: MutableStateFlow<kotlin.Pair<Long, Long>> = MutableStateFlow(kotlin.Pair(0, 0)),
    ...
    val foundDevices: MutableStateFlow<List<DeviceBle>> = MutableStateFlow(emptyList()),
