...
data class DataForWork (
    val plan: MutableStateFlow<Plan?> = MutableStateFlow(null),
    val enableSpeechDescription: MutableStateFlow<Boolean> = MutableStateFlow(true),
    ...
    val indexRound: Int = 0,
    val indexExercise: Int = 0,
    val indexSet: Int = 0,
...
//        dataFromWork?.stepTraining?.value = if (map.isNotEmpty()) map[indexMap] else null
    ...
    fun sendStepTrainingShort(indexMap: Int){
