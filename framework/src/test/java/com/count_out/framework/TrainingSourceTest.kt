...
//    private val trainingSource = PlanSourceImpl(dao, ringSource, speechKitSource)
//
//    @ExperimentalCoroutinesApi
//    @Test
//    fun testAddTraining() = runTest {
//        val training = TypeSource.PlanT( createTraining())
//        whenever(dao.insert(TrainingTable(training.item))).thenReturn(1L)
...
//            flowOf( listOf(
//                TrainingRelo(training = TrainingTable(list[0]), rounds = emptyList(), rings =  emptyList(), speechKit = null),
//                TrainingRelo(training = TrainingTable(list[1]), rounds = emptyList(), rings =  emptyList(), speechKit = null),
//                TrainingRelo(training = TrainingTable(list[2]), rounds = emptyList(), rings =  emptyList(), speechKit = null),
//            ))
//        )
