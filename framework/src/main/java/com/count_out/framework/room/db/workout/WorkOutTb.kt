package com.count_out.framework.room.db.workout

import androidx.room.Entity
import androidx.room.Ignore
import androidx.room.PrimaryKey
import com.count_out.data.models.entity.WorkoutDb
import com.count_out.domain.entity.weather.Weather
import com.count_out.domain.entity.workout.Plan

@Entity(tableName = "workout_tb")
data class WorkOutTb(
    ...
    @Ignore override val plan: Plan? = null,
) : WorkoutDb {

    override fun formPlan(plan: Plan) {
