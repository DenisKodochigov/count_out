...
abstract class RepositoryBindModule {
    ...
    @Binds
    abstract fun bindSettingsRepo(exerciseRepoImpl: SettingsRepoImpl): SettingsRepo
    @Binds
    ...
    @Binds
    abstract fun bindLocationRepo(exerciseRepoImpl: LocationRepoImpl): LocationRepo
    @Binds
