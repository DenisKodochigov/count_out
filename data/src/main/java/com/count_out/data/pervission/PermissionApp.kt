package com.count_out.data.pervission
...
fun RequestPermissionsAll(){
    RequestPermissions(PermissionApp(context = TODO()).permissions1)
    RequestPermissions(PermissionApp(context = TODO()).permissions2)
