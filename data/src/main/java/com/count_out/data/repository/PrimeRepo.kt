...
//        return this.filterNotNull().map{ resultS->
//            when(resultS){
//                is ResultSource1.Error -> ResultDomain.Error(ThrowableUC.extract(resultS.throwable))
//                is ResultSource1.Success -> ResultDomain.Success(formTbtoElement(resultS.data))
//            }
//        }
//    }
