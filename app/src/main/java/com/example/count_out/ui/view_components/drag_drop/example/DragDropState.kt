...
class DragDropState1 internal constructor(
    ...
    private val draggingItemLayoutInfo: LazyListItemInfo? = state.layoutInfo.visibleItemsInfo
            .firstOrNull { it.index == currentIndexOfDraggedItem }
    internal val draggingItemOffset: Float = draggingItemLayoutInfo?.let { item ->
        draggingItemInitialOffset + draggedDistance - item.offset } ?: 0f
    ...
    private val initialOffsets: Pair<Int, Int>? = initiallyDraggedElement?.let { Pair(it.offset, it.offsetEnd) }
