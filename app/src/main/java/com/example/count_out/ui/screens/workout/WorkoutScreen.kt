...
@Composable fun WorkoutScreen(workoutId: Long, onClickWorkout: (Long) -> Unit, screen: ScreenDestination,
){
...
@Composable
fun WorkoutScreenLayout( uiState: WorkoutScreenState
) {
...
@Composable
fun WorkoutLazyColumn(uiState: WorkoutScreenState, scrollOffset:Int,
){
    TopBar(uiState, scrollOffset)
    Spacer(modifier = Modifier.height(2.dp))
    LazyList(uiState)
}
@Composable fun TopBar(uiState: WorkoutScreenState, scrollOffset:Int){
    CollapsingToolbar(
...
@Composable fun LazyList(uiState: WorkoutScreenState)
{
...
@Composable fun RowLazy(item: Workout, uiState: WorkoutScreenState, modifier: Modifier){
...
@Composable fun IconStart(uiState: WorkoutScreenState){}
@Composable fun IconEnd(uiState: WorkoutScreenState){}
@Composable fun NameWorkout(item: Workout, uiState: WorkoutScreenState,){}