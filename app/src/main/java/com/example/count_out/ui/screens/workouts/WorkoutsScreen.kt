...
@Composable fun TopBar(uiState: WorkoutsScreenState, scrollOffset:Int){
    CollapsingToolbar(
...
@Composable fun IconStart(uiState: WorkoutsScreenState){}
@Composable fun IconEnd(uiState: WorkoutsScreenState){}
