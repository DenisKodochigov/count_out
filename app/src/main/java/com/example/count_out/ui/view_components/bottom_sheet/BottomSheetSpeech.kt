...
fun bottomSheetStateNew(itemSpeech: BottomSheetInterface): BottomSheetState {
    val speech = when (itemSpeech.item) {
        is Training -> (itemSpeech.item as Training).speech ?: SpeechKitImpl()
        is Exercise -> (itemSpeech.item as Exercise).speech ?: SpeechKitImpl()
        is Round -> (itemSpeech.item as Round).speech ?: SpeechKitImpl()
        is Set -> (itemSpeech.item as Set).speech ?: SpeechKitImpl()
        else -> SpeechKitImpl()
    }
