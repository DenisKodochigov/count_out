...
@Composable fun PlayWorkoutScreenLayoutContent( uiState: PlayWorkoutScreenState
    ...
    Row( horizontalArrangement = Arrangement.Center, verticalAlignment = Alignment.Bottom,
        ...
        ButtonApp(text = "Start", onClick = { /*TODO*/ }, modifier = Modifier.padding(18.dp))
        ButtonApp(text = "Pause", onClick = { /*TODO*/ }, modifier = Modifier.padding(18.dp))
        ButtonApp(text = "Stop", onClick = { /*TODO*/ }, modifier = Modifier.padding(18.dp))
    }
}
