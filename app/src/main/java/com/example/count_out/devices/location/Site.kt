package com.example.count_out.devices.location
...
class Site @Inject constructor( private val context: Context, val permission: PermissionApp) {
...
//        if (!permission.checkLocation()) return
    ...
    @SuppressLint("MissingPermission")
    fun stop(){
//        if(permission.checkLocation() && status)
