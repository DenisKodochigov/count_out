...
import com.example.count_out.devices.bluetooth.modules.BleStates
...
import com.example.count_out.entity.enums.HciStatus
import com.example.count_out.entity.enums.StateBleConnecting
...
class BleConnecting @Inject constructor(
    ...
    private fun hciStatusFromValue(value: Int) =
        HciStatus.entries.find { item-> item.param == value } ?: HciStatus.UNKNOWN_STATUS_CODE
