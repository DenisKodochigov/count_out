...
import com.example.count_out.presentation.models.TrainingImpl
import com.example.count_out.presentation.navigation.NavigateEventImpl
import com.example.count_out.presentation.prime.Action
import com.example.count_out.presentation.prime.PrimeScreen
import com.example.count_out.presentation.screens.training.round.Round
...
//    val dataState = viewModel.trainingScreenState.collectAsState()
//    dataState.value.onDismissSelectActivity = { dataState.value.showBottomSheetSelectActivity.value = false }
...
@Composable fun EditSpeech(dataState: TrainingState, action:Action) {
    ...
    if (dataState.showBottomSheetSelectActivity.value) BottomSheetSelectActivity(dataState)
}
@SuppressLint("UnrememberedMutableState")
@Composable
        ...
        modifier = Modifier.fillMaxWidth().padding(bottom = 6.dp))
    {
        TextFieldApp(
            ...
            onChangeValue = {
                ...
                action.ex( TrainingEvent.ChangeNameTraining(
