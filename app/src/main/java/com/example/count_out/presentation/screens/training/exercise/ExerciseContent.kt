package com.example.count_out.presentation.screens.training.exercise
...
import com.example.count_out.presentation.screens.training.set.SetContent
        ...
        exercise.sets.forEachIndexed { ind, set ->
            Box (modifier = Modifier
                ...
                content = { SetContent(dataState, action,
                    (set as SetImpl).copy(positions = ind to exercise.sets.count())) }
            )
