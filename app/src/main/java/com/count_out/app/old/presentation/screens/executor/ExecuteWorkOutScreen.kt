...
//import com.count_out.app.domain.minus
//import com.count_out.app.domain.plus
//import com.count_out.app.presentation.navigation.NavigateEventImpl
//import com.count_out.app.ui.bottom_sheet.BottomSheetSaveTraining
//import com.count_out.presentation.models.NextExercise
...
//                text3 = "${set.weight / ( if (set.weight.unit == Units.KG) 1000 else 1 ) }",
//                text4 = "${uiState.currentRest}",
//            )
//            //Total target (unit)
//            ColumnsA(
...
//                modifier = Modifier.padding(start = 12.dp).width(100.dp),
//                text1 = "${uiState.stepTraining.quantitySet }",
//                text2 = "${set.duration/( if (set.duration.unit == Units.M) 60 else 1) }" +
