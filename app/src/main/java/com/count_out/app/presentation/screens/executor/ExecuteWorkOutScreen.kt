...
import com.count_out.app.presentation.models.NextExercise
...
//            val text = if (Activity.name.isNullOrEmpty()) "" else
//                "${Activity.name ?: ""}:" +
...
//                Goal.CountGroup -> {}
//            }
//            NextExercise(uiState.stepTraining?.nextExercise.toString())
//        }
//    }
//}
