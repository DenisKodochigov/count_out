...
@Singleton
@AndroidEntryPoint
class CountOutServiceImpl @Inject constructor(): Service() {
...
//    @Inject lateinit var logging: Logging
    ...
    inner class DistributionServiceBinder: Binder() { fun getService(): CountOutServiceImpl = this@CountOutServiceImpl }
