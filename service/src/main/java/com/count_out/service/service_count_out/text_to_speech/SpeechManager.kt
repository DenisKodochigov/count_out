package com.count_out.service.service_count_out.text_to_speech
...
//                messengerA.messageApi("TextToSpeech not created")
    ...
    suspend fun speech(dataFromWork: FromWork, speech: Speech, addMessage:String = ""): Long {
        dataFromWork.trap()
        val speechText = speech.message + " " + addMessage
    ...
    private fun speakOutAdd(text: String, dataFromWork: FromWork){
        dataFromWork.trap()
