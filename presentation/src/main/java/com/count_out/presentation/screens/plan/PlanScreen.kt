...
//import com.count_out.presentation.screens.plans.plan.CarcassPlanScreen
...
//    )
//}
//@Composable fun PartList(dataState: PlanState){
...
//    dataState.event(PlanEvent.Launcher(LauncherBSp().init(TypeBS.Speech, item)))
//}
//fun showActivities(dataState: PlanState, owner: Domain, listActivity: List<Domain>){
//    dataState.event(PlanEvent.Launcher(LauncherBSp().init(TypeBS.Activity, owner, listActivity)))
//}
//fun showChangeOrder(dataState: PlanState, owner: Domain, list: List<Domain>){
//    dataState.event(PlanEvent.Launcher(LauncherBSp().init(TypeBS.Order, owner, list)))
//}
