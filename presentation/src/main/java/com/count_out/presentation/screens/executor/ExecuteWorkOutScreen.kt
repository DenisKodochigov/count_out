...
@Composable fun ExecuteWorkoutScreen(viewModel: ExecuteWorkViewModel, trainingId: Long ){
...
@Composable fun LayoutCount(uiState: ExecuteWorkoutScreenState) {
    ...
    Row(modifier = Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.End) {
        TextApp(text = stringResource(R.string.interval) + ":", style = MaterialTheme.typography.bodyLarge,
