...
class TrainingsViewModelToUCTest {
    ...
    companion object{
        ...
        val updatePlanUC = mock<UpdatePlanUC>()
        ...
        fun beforeAll() {
            ...
            viewModel = PlansViewModel(
                copyTrainingUC, delTrainingUC,getTrainingsUC,updatePlanUC, selectTrainingUC, updateSpeechKitUC)
        }
        @JvmStatic
        @AfterAll
...
//        val exceptionScreenState = ScreenState.Success(dataState = PlansState( trainings = listTraining))
        whenever(updatePlanUC.execute(UpdatePlanUC.Request(training1)))
